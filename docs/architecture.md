...
PenEcho is a Node.js application with a static browser client, one server-side image encoding dependency, and selectable API or Codex CLI model execution.
